# Template - IBM DB2 ESE 11.1 on a single VM
Template Version - 1.0

## Description

This template deploys a standalone instance of IBM DB2 Enterprise Server Edition 11.1 on a Linux virtual machine.<br>
